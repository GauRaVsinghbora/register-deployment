...
if(loginform){
    ...
    try {
        const response = await fetch('https://register-deployment.onrender.com/api/users/login', {
            method: 'POST',
            headers: {
...
if(form){
    ...
    try {
        const response = await fetch('https://register-deployment.onrender.com/api/users/register', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
